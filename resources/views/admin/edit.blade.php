...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <form action="/admin/{{ $menu->id }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="category" id="category"
                                ...
                                @foreach ([
                                    ...
                                    <option value="{{ $item->value }}" @selected(old('category', $menu->category) == $item->value)>{{ $item->label }}
                                    </option>
                                @endforeach
                            </select>
                            @error('category')
                        ...
                        <div class="form-group mb-3">
                            ...
                            @if ($menu->image)
                                <div class="mt-3">
                                    <img src="{{ asset('storage/' . $menu->image) }}" alt="Gambar Produk" width="150">
                                </div>
                            @endif
                        </div>
